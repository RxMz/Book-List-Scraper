...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post terms_url, params: { term: { term_code: @term.term_code, term_description: @term.term_description } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { term_code: @term.term_code, term_description: @term.term_description } }
